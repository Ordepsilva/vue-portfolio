      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card
            ...
            :key="index"
            class="group overflow-hidden glass-effect border-border hover:border-primary/50 transition-all duration-300 hover:animate-glow-pulse"
          >
            <div class="relative overflow-hidden">
              ...
              />
              <div
                class="absolute inset-0 bg-black/60 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center"
              >
            ...
            <div class="p-6">
              ...
              <div class="flex flex-wrap gap-2">
                <span
                  ...
                  :key="techIndex"
                  class="px-3 py-1 text-xs font-mono bg-muted rounded-full text-primary"
                >
                  {{ tech }}
                </span>
              </div>
